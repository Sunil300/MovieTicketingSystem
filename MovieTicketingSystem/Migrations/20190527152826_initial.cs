        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatAmount = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StopShowing = table.Column<DateTime>(nullable: false),
                    Synopsis = table.Column<string>(nullable: true),
                    IsOnCarousel = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlayingId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TimeSlotId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Playing_Movie_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movie",
                        principalColumn: "MovieId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Playing_Room_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Room",
                        principalColumn: "RoomId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Playing_TimeSlot_TimeSlotId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ticket_Playing_PlayingId",
                        column: x => x.PlayingId,
                        principalTable: "Playing",
                        principalColumn: "PlayingId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Playing_MovieId",
                table: "Playing",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_Playing_RoomId",
                table: "Playing",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Playing_TimeSlotId",
                table: "Playing",
                column: "TimeSlotId");

            migrationBuilder.CreateIndex(
                name: "IX_Ticket_PlayingId",
                table: "Ticket",
                column: "PlayingId");
        }
